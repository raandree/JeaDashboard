...
FunctionsToExport = @('Get-DatumRSOP','Get-FileProviderData','Get-MergeStrategyFromPath','Invoke-TestHandlerAction','Merge-Datum','New-DatumFileProvider','New-DatumStructure','Resolve-Datum','Resolve-DatumPath','Test-TestHandlerFilter')
...
PrivateData = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = '## [0.39.0] - 2020-09-29
